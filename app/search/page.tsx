  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)]">
        ...
        >
          <div className="mb-6 flex items-center justify-center w-20 h-20 rounded-2xl bg-muted">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed mb-6">
            Esta funcionalidade está sendo desenvolvida e em breve estará
            disponível para você encontrar os melhores imóveis.
          </p>
