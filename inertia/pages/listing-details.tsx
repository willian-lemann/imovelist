...
import { BathIcon, BedIcon, LayoutGrid, RulerIcon, Share2Icon, XIcon } from 'lucide-react'
      ...
      <section className="bg-white">
        <div className="container px-4 py-8 md:px-8 md:py-12">
          ...
          <div className="flex justify-between items-center mb-5">
            <h1 className="text-2xl md:text-3xl font-bold">{listing.name || listing.address}</h1>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <div className="relative h-auto rounded-lg overflow-hidden">
                  <img src={listing.image} className="object-cover" alt="Main property image" />
                </div>
              </DialogTrigger>
              ...
              <DialogContent className="h-full max-w-3xl bg-transparent outline-none shadow-none border-none">
                ...
                <img src={listing.image} className="object-cover" alt="Foto de um imovel" />
              </DialogContent>
            </Dialog>

            <div className="grid grid-cols-2 gap-4 relative">
              {listing.photos.slice(0, 4).map((photo: { href: string; listingItemId: string }) => (
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            <div className="md:col-span-2">
              <h2 className="text-xl font-semibold mb-4">Entire place in {listing.address}</h2>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    <div className="text-2xl font-bold">R$ {listing.price.toLocaleString()}</div>
                  </div>
